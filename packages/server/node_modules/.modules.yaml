...
hoistedDependencies:
  ...
  /touch/3.1.0:
    touch: private
  /ts-is-defined/1.0.0:
    ts-is-defined: private
  /ts-tiny-invariant/0.0.3:
    ts-tiny-invariant: private
  /tslib/2.2.0:
    tslib: private
  /type-fest/0.8.1:
    type-fest: private
...
pendingBuilds: []
prunedAt: Wed, 21 Jul 2021 14:35:45 GMT
publicHoistPattern:
  - '*types*'
  - '*eslint*'
  - '@prettier/plugin-*'
...
skipped:
  - /fsevents/2.3.2
storeDir: C:\Users\Adm\.pnpm-store\v3
virtualStoreDir: >-
  C:\curso-dev\graphql-so-montagem-do-servidor\mono
  cors\ualllall\packages\server\node_modules\.pnpm
